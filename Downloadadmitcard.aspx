<%@ Page Title="BSEB - Admin Dashboard | Download Admitcard" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Downloadadmitcard.aspx.cs" Inherits="Downloadadmitcard" %>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Download Dummy Admit Card</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
