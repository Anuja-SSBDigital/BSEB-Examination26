        ...
        if (!IsPostBack)
        {
            ...
            if (!string.IsNullOrEmpty(errorCode))
            {
               ...
               // lbl_orderid.Text = paymentRef;
                ...
                string updateResult = db.Updatepaymentdataofhdfcorderidwise(
                    orderRef,
                    null,              // AmountPaid
            ...
            try
            {
                ...
                string respayment = db.Updatepaymentdataofhdfcorderidwise(orderId, paidAmount.ToString(), statusdb, paymentMode, paymentId, transactionDateString, errorCode);
