...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="row g-4">
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="category-header science text-center">Science</div>
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="category-header arts text-center">Arts</div>
                <div class="table-responsive">
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="category-header commerce text-center">Commerce</div>
                <div class="table-responsive">
